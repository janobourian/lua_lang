...
10. [Step-by-Step Production Lab: Zero-Pollution Config Validator & Route Engine](#10-step-by-step-production-lab-zero-pollution-config-validator--route-engine)
...
1. [Roberto Ierusalimschy: Programming in Lua (4th Edition, Lua.org)](https://www.lua.org/pil/)
2. [Eli Bendersky: Understanding Lua Internals: VM Registers and Scopes](https://eli.thegreenplace.net/)
3. [Cloudflare Engineering: Writing Bulletproof Lua Code for Multi-Tenant Edge Proxies](https://blog.cloudflare.com/)
4. [Datadog Engineering: Tracking High-Throughput Lua Application Latency](https://www.datadoghq.com/blog/)
5. [High-Performance Linux Systems: Lua vs V8 in High-Concurrency API Gateways](https://www.kernel.org/)
