...
10. [Step-by-Step Production Lab: High-Performance C Bit Array Userdata Driver](#10-step-by-step-production-lab-high-performance-c-bit-array-userdata-driver)
...
1. [Roberto Ierusalimschy: Programming in Lua (4th Edition, Part IV: Userdata)](https://www.lua.org/pil/)
2. [Eli Bendersky: Userdata and Metatables in Lua C Extensions](https://eli.thegreenplace.net/)
3. [Cloudflare Engineering: Wrapping High-Performance C Structures in Lua](https://blog.cloudflare.com/)
4. [Datadog Engineering: Memory Safety in Userdata C Extensions](https://www.datadoghq.com/blog/)
5. [High-Performance Linux Systems: Memory-Mapped Files and Bit Arrays via Userdata](https://www.kernel.org/)
