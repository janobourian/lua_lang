...
12. [Step-by-Step Production Lab: High-Performance In-Memory LRU Cache Engine](#12-step-by-step-production-lab-high-performance-in-memory-lru-cache-engine)
...
6. [Roberto Ierusalimschy: Programming in Lua (Chapter 14: Data Structures)](https://www.lua.org/pil/14.html)
7. [Eli Bendersky: Implementing High-Performance Data Structures in Lua](https://eli.thegreenplace.net/)
8. [Cloudflare Engineering: Optimizing Lua Table Allocation and Memory Layout](https://blog.cloudflare.com/)
9. [Datadog Engineering: Profiling High-Throughput Lua Table Allocations](https://www.datadoghq.com/blog/)
10. [High-Performance Linux Systems: Memory-Efficient LRU Caches in Lua and C](https://www.kernel.org/)
