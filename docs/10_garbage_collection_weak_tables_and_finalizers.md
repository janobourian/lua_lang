...
11. [In-Depth Engineering Perspectives](#11-in-depth-engineering-perspectives)
12. [Well-Architected Systems Programming Principles](#12-well-architected-systems-programming-principles)
13. [Step-by-Step Production Lab: Ephemeral Memory-Bounded Cache & GC Profiler](#13-step-by-step-production-lab-ephemeral-memory-bounded-cache--gc-profiler)
14. [Pure CLI / Command Interface](#14-pure-cli--command-interface)
15. [Advanced Architecture & Edge-Case Failure Modes](#15-advanced-architecture--edge-case-failure-modes)
16. [Detailed Sub-Components & Subsystems](#16-detailed-sub-components--subsystems)
17. [References (The 5+5 Rule)](#17-references-the-55-rule)
18. [Universal FinOps & Hardware Cost Governance](#18-universal-finops--hardware-cost-governance)
...
6. [Roberto Ierusalimschy: Programming in Lua (Chapter 23: Garbage Collection)](https://www.lua.org/pil/23.html)
7. [Eli Bendersky: Garbage Collection in Lua Internals](https://eli.thegreenplace.net/)
8. [Cloudflare Engineering: Eliminating GC Latency Spikes in Edge Gateways](https://blog.cloudflare.com/)
9. [Datadog Engineering: Real-Time Memory Leak Detection in Dynamic Scripting](https://www.datadoghq.com/blog/)
10. [High-Performance Linux Systems: Generational vs Incremental Memory Collectors](https://www.kernel.org/)
